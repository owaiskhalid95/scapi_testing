...
public class regression extends  TestScript{
    ...
    public void update_user() {
        ...
        response = new APIResponses(request.update_users(id,"sharon@sim.com","Sharon123@",generatedString,"sharon"));
        displayResponses();
        AssertTest.assertValue(response.status_code(), "200", "FAIL: Unexpected response status", "PASS: Expected response status");
    ...
    public void get_user_details() {
        System.out.println(" STEP03: === Update User");
        String str=  request.get_user_username("sharon");
        displayResponses();
        AssertTest.assertValue(response.status_code(), "200", "FAIL: Unexpected response status", "PASS: Expected response status");
        AssertTest.assertValue(response.getValue("password"), "Sharon123@", "FAIL: Unexpected response message", "PASS: Expected response message");
        AssertTest.assertValue(response.getValue("id"), id, "FAIL: Unexpected response message", "PASS: Expected response message");
    ...
    public void user_login() {
        ...
        String str=  request.user_login("sharon","wdawdada");
        displayResponses();
        AssertTest.assertValue(response.status_code(), "200", "FAIL: Unexpected response status", "PASS: Expected response status");
        AssertTest.assertValue(response.getValue("password"), "Sharon123@", "FAIL: Unexpected response message", "PASS: Expected response message");
        AssertTest.assertValue(response.getValue("id"), id, "FAIL: Unexpected response message", "PASS: Expected response message");
    ...
    public void user_logout() {
        System.out.println(" STEP05: === user logout");
        String str=  request.user_logout();
        displayResponses();
        AssertTest.assertValue(response.status_code(), "200", "FAIL: Unexpected response status", "PASS: Expected response status");
        AssertTest.assertValue(response.getValue("password"), "Sharon123@", "FAIL: Unexpected response message", "PASS: Expected response message");
        AssertTest.assertValue(response.getValue("id"), id, "FAIL: Unexpected response message", "PASS: Expected response message");
  ...
  /*  @Test(priority = 3)
    public void delete_user() {
        ...
        response = new APIResponses(request.delete_user("ayesha"));
        displayResponses();
        AssertTest.assertValue(response.status_code(), "200", "FAIL: Unexpected response status", "PASS: Expected response status");
        AssertTest.assertValue(response.getValue("code"), "200", "FAIL: Unexpected response message", "PASS: Expected response message");
